...
public class T1_Alert_Practices {
    ...
    public void alert_test1() throws InterruptedException {
        ...
        WebElement resltText= driver.findElement(By.xpath("//p[@id='result']"));

        //Failure message will only be displayed if assertion fails: "Result text is NOT displayed."

        Assert.assertTrue(resltText.isDisplayed(),"Result text is not displayed");


        String expectedResultText="You successfully clicked an alert";
        String actualResultText=resltText.getText();
