...
public class T5_getText_getAttribute {
    ...
    public static void main(String[] args) {
        ...
        String actualLastNamePlaceHolder=lastNameInput.getAttribute("placeholder");
        System.out.println(actualLastNamePlaceHolder);

        if (actualLastNamePlaceHolder.equals(expectedLastNamePlaceHolder)){
            System.out.println("Placeholder text verification PASSED!");
        }else{
            System.out.println("Placeholder text verification FAILED!!!");
        }
